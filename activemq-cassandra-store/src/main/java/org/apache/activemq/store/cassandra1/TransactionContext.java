...
public class TransactionContext {
    ...
    private final CassandraPersistenceAdapter persistenceAdapter;
    ...
    public TransactionContext(CassandraPersistenceAdapter persistenceAdapter) throws IOException {
...
//        this.dataSource = persistenceAdapter.getDataSource();
    ...
    public Connection getConnection() throws IOException {
        if (connection == null) {
            try {
                ...
                CassandraPersistenceAdapter.log("Could not get JDBC connection: ", e);
    ...
    public void close() throws IOException {
        if (!inTx) {
            try {
                ...
                CassandraPersistenceAdapter.log("Error while closing connection: ", e);
    ...
    public void commit() throws IOException {
        ...
        try {
            ...
            CassandraPersistenceAdapter.log("Commit failed: ", e);
    ...
    public void rollback() throws IOException {
        ...
        try {
            ...
            CassandraPersistenceAdapter.log("Rollback failed: ", e);
            throw IOExceptionSupport.create(e);
        } finally {
            inTx = false;
            close();
