...
import org.apache.activemq.store.cassandra1.adapter.DefaultJDBCAdapter;
...
/**
 * A {@link PersistenceAdapter} implementation using Cassandra for persistence
 * storage.
 *
...
public class CassandraPersistenceAdapter extends LockableServiceSupport implements PersistenceAdapter {
    ...
    public CassandraPersistenceAdapter() {
    }
    ...
    public Set<ActiveMQDestination> getDestinations() {
        ...
        try {
            ...
            CassandraPersistenceAdapter.log("JDBC Failure: ", e);
            return emptyDestinationSet();
        } finally {
            if (c != null) {
                try {
        ...
        if (isCreateTablesOnStartup()) {
            ...
            try {
                try {
                    ...
                    CassandraPersistenceAdapter.log("Failure Details: ", e);
                }
            } finally {
...
//    }
    ...
    public String toString() {
        return "CassandraPersistenceAdapter(" + super.toString() + ")";
    }
