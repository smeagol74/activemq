...
public class JDBCMessageStore extends AbstractMessageStore {
    ...
    protected final CassandraPersistenceAdapter persistenceAdapter;
    ...
    public JDBCMessageStore(CassandraPersistenceAdapter persistenceAdapter, JDBCAdapter adapter, WireFormat wireFormat, ActiveMQDestination destination, ActiveMQMessageAudit audit) throws IOException {
        super(destination);
