...
public class DefaultDatabaseLocker extends AbstractLocker {
    ...
    public void configure(PersistenceAdapter adapter) throws IOException {
        if (adapter instanceof CassandraPersistenceAdapter) {
//            this.dataSource = ((CassandraPersistenceAdapter) adapter).getLockDataSource();
            this.dataSource = null;
            this.statements = ((CassandraPersistenceAdapter) adapter).getStatements();
        }
    }
